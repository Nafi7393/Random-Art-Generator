...
def circle_image(image, image_size_px, num_circle, radius,
                 start_color, end_color, stroke_color, effect, stroke_width=15):
    ...
    for i in range(num_circle):
        ...
        left_point, right_point = all_functions.get_circle_cord(circle_center, position, radius)
...
def rect_image(image, image_size_px, num_rect,
               start_color, end_color, stroke_color, rect_size,
    ...
    for i in range(num_rect):
        ...
        circle_center = random.randint(0, image_size_px)
        position = random.randint(0, image_size_px)
        left_point, right_point = all_functions.get_rect_cord(circle_center, position, rect_size)
